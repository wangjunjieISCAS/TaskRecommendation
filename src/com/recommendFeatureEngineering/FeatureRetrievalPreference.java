...
public class FeatureRetrievalPreference {
	...
	public HashMap<String, ArrayList<Double>> retrievePreferenceFeatures ( TestProject project, TestTask task, int recTimePoint, 
		...
		HashMap<String, Double> mannSimList = retrievalTool.retrieveManhattanSimilarity(probPreference, testAdeq);
		
		HashMap<String, Double> eucSimTestList = retrievalTool.retrieveEuclideanSimilarityTest(probPreference, testAdeq);
		HashMap<String, Double> mannSimTestList = retrievalTool.retrieveManhattanSimilarityTest(probPreference, testAdeq);
		
		HashMap<String, Double> jacSimList = retrievalTool.retrieveJaccardSimilarity(probPreference, testAdeq, 0.6);
		HashMap<String, Double> jacSimList2 = retrievalTool.retrieveJaccardSimilarity(probPreference, testAdeq, 0.7);
		HashMap<String, Double> jacSimList3 = retrievalTool.retrieveJaccardSimilarity(probPreference, testAdeq, 0.8);
		HashMap<String, Double> jacSimList4 = retrievalTool.retrieveJaccardSimilarity(probPreference, testAdeq, 0.9);
