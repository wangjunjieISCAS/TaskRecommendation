...
public class WorkerPreferenceHistory {
	...
	public static void main ( String args[] ){
		...
		HashMap<String, HashMap<Date, Double[]>> workerPreferenceHistorySemantic = history.retrieveWorkerPreferenceHistorySemantic ( workerPreferenceHistory ); 
 		history.storeWorkerPreferenceHistorySemantic (workerPreferenceHistorySemantic, "data/output/history/semanticPreference.txt" );
		/*
